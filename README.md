...
Platforms are defined in `platform/<name>/`: `config.sh` describes the target
memory/ISA and `bios.c` implements the console and storage interface. Included
platforms:

| Platform | Target | Notes |
| --- | --- | --- |
| `vemu` | [vemu](https://mazin-o3.github.io/vemu/) web emulator | 64 KB RAM at address 0 |
| `pico2` | Raspberry Pi Pico 2 (RP2350, RISC-V cores) | 256 KB RAM, UART console, flash disk — see [platform/pico2](platform/pico2/README.md) |
